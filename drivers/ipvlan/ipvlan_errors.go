...
func (ece *ErrConfigExists) Error() string {
	return "configuration already exists, driver configuration can be applied only once"
}
...
func (eidc *ErrInvalidDriverConfig) Error() string {
	return "Invalid configuration passed to the network driver"
}
...
func (ene *ErrNetworkExists) Error() string {
	return "network already exists, driver can only have one network"
}
...
// ErrNoIPAddr error is returned when driver has no IPv4 address configured.
type ErrNoIPAddr struct{}

func (enip *ErrNoIPAddr) Error() string {
	return "driver has no IPv4 address configured"
}
...
func (eis *ErrInvalidContainerSubnet) Error() string {
	return "container subnet must be a subset of driver network"
}
...
// IPv4AddrAddError is returned when IPv4 address could not be added to the driver.
...
func (ipv4 *IPv4AddrAddError) Error() string {
	return fmt.Sprintf("failed to add IPv4 address %s to driver: %v", ipv4.IP, ipv4.Err)
}

// InternalError denotes the type of this error
func (ipv4 *IPv4AddrAddError) InternalError() {}

// IPv6AddrAddError is returned when IPv6 address could not be added to the driver.
...
func (ipv6 *IPv6AddrAddError) Error() string {
	return fmt.Sprintf("failed to add IPv6 address %s to driver: %v", ipv6.IP, ipv6.Err)
}
